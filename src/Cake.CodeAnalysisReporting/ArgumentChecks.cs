namespace Cake.CodeAnalysisReporting
{
    ...
    internal static class ArgumentChecks
    {
        ...
        /// <summary>
        /// Throws an exception if the specified parameter's value is <see cref="CodeAnalysisReport.Undefined"/>.
        /// </summary>
        /// <param name="value">The value of the argument.</param>
        /// <param name="parameterName">The name of the parameter to include in any thrown exception.</param>
        /// <exception cref="ArgumentOutOfRangeException">Thrown if <paramref name="value"/> is <see cref="CodeAnalysisReport.Undefined"/></exception>
        [DebuggerStepThrough]
